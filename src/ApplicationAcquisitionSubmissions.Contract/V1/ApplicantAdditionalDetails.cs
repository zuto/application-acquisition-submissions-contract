...
namespace ApplicationAcquisitionSubmissions.Contract.V1
{
    ...
    {        
        [AllowedValuesValidation(new[]{ "MARRIED", "COHABITING", "LIVING WITH PARTNER", "SINGLE", "SEPARATED", "DIVORCED", "WIDOWED", "UNKNOWN"})]
        public string MaritalStatus { get; set; }        

        [AllowedValuesValidation(new[]{ "FULL UK", "PROVISIONAL UK", "EUROPEAN", "INTERNATIONAL", "NONE", "CBT", "A2","FULL A CLASS", "UNKNOWN" })]
